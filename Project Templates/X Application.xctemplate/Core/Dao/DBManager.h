...
#define kDBTableActType     @"kDBTableActType"
#define kDBTableActAddress  @"kDBTableActAddress"
#define kDBTableClubType    @"kDBTableClubType"
 ...
 *  @return 数据对象
 */
+ (id<DBModelDelegate>)modelWithDBDic:(NSDictionary *)dic;
@end
