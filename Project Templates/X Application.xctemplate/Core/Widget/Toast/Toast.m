...
- (id)initWithText:(NSString *)text_{
    if (self = [super init]) {
        ...
        CGSize textSize = [text sizeWithFont:font
                           constrainedToSize:CGSizeMake([Util screenWidth]-EDG_OFFSET*4, MAXFLOAT)
...
+ (void)showWithText:(NSString *)text_{
    [Toast showWithText:text_ duration:DISPLAY_DURATION];
}
...
+ (void)showWithText:(NSString *)text_
    ...
    [Toast showWithText:text_  topOffset:topOffset_ duration:DISPLAY_DURATION];
}
...
+ (void)showWithText:(NSString *)text_
    ...
    [Toast showWithText:text_  bottomOffset:bottomOffset_ duration:DISPLAY_DURATION];
}
